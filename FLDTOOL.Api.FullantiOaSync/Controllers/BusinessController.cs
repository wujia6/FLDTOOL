...
namespace FLDTOOL.Api.FullantiOaSync.Controllers
{
    [Tags("业务系统")]
    [ApiController]
    [Route("fld/dg/business")]
    public class BusinessController(IOptionsMonitor<OaOptions> oa, HttpWebClient httpWebClient) : ControllerBase
    {
        ...
        public async Task<dynamic> QuickQuoteAsync([Description("OA账号")] string loginName, [FromBody] QuotationDto dto)
        {
            ...
            string formMain = "formmain_0374", formSon = "formson_0375", template = "KHBJ";
            //构建请求数据
